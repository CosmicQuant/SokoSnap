                                ...
                                <div className="space-y-1">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-10 p-3 bg-white border rounded-xl text-sm outline-none transition-all ${errors.phone ? 'border-red-500 focus:ring-2 focus:ring-red-100' : 'border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100'
                                                }`}
                                        />
                                    </div>
                                ...
                                <div className="space-y-1">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-10 p-3 bg-white border rounded-xl text-sm outline-none transition-all ${errors.location ? 'border-red-500 focus:ring-2 focus:ring-red-100' : 'border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100'
                                                }`}
                                        />
                                    </div>
